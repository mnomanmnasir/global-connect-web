...
function(i) {
    ...
    (function(t) {
        ...
        function b() {
            var e, i;
            v.length && (h = void 0 !== n.window.pageYOffset ? n.window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, e = p || !w || w.width !== f || w.height !== m, i = g || e || !w || w.y !== h, g = p = !1, (e || i) && (v.forEach(function(t) {
    ...
    c.prototype = {
        ...
        _findBackgrounds: function() {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function() {
                ...
                }), t = s.data("stellar-horizontal-offset") !== m ? s.data("stellar-horizontal-offset") : n !== m && n.data("stellar-horizontal-offset") !== m ? n.data("stellar-horizontal-offset") : u.horizontalOffset, e = s.data("stellar-vertical-offset") !== m ? s.data("stellar-vertical-offset") : n !== m && n.data("stellar-vertical-offset") !== m ? n.data("stellar-vertical-offset") : u.verticalOffset, u.backgrounds.push({
                    $element: s,
                    $offsetParent: n,
...
function() {
    var c, o, d, u, t, r, p, k, n, f, l, s, h, i, m, A, a, e, g, y = [].slice;

    function v(t) {
        var e, i, o, n, s, r, a, l = this;
        if (this.options = t, this.el = this.options.el, null != this.el.odometer) return this.el.odometer;
        for (e in this.el.odometer = this, r = v.options) o = r[e], null == this.options[e] && (this.options[e] = o);
        null == (t = this.options).duration && (t.duration = c), this.MAX_VALUES = this.options.duration / u / d | 0, this.resetFormat(), this.value = this.cleanValue(null != (t = this.options.value) ? t : ""), this.renderInside(), this.render();
        try {
            for (n = 0, s = (a = ["innerHTML", "innerText", "textContent"]).length; n < s; n++) i = a[n], null != this.el[i] && function(e) {
    ...
    o = /^\(?([^)]*)\)?(?:(.)(d+))?$/, c = 2e3, d = 2, u = 1e3 / 30, g = document.createElement("div").style, p = null != g.transition || null != g.webkitTransition || null != g.mozTransition || null != g.oTransition, h = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, t = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, n = function(t) {
        ...
        if (!a && null != window.jQuery) {
            for (a = !0, n = [], e = 0, i = (o = ["html", "text"]).length; e < i; e++) t = o[e], n.push(function() {
    ...
    })(), setTimeout(g, 0), v.prototype.renderInside = function() {
        ...
        if (!this.transitionEndBound) {
            for (this.transitionEndBound = !0, e = !1, s = [], i = 0, o = (n = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd".split(" ")).length; i < o; i++) t = n[i], s.push(this.el.addEventListener(t, function() {
                return e || (e = !0, setTimeout(function() {
                    return r.render(), e = !1, m(r.el, "odometerdone")
                }, 0)), !0
            }, !1));
            return s
        }
        ...
        if (i = i || "d", !(t = o.exec(i))) throw new Error("Odometer: Unparsable digit format");
        ...
        var e, i, o, n, s, r, a, l, c, d, u, h;
        for (null == t && (t = this.value), this.stopWatchingMutations(), this.resetFormat(), this.inside.innerHTML = "", r = this.options.theme, s = [], l = 0, d = (e = this.el.className.split(" ")).length; l < d; l++)(i = e[l]).length && ((n = /^odometer-theme-(.+)$/.exec(i)) ? r = n[1] : /^odometer(-|$)/.test(i) || s.push(i));
        for (s.push("odometer"), p || s.push("odometer-no-transitions"), s.push(r ? "odometer-theme-" + r : "odometer-auto-theme"), this.el.className = s.join(" "), this.ribbons = {}, this.digits = [], a = !this.format.precision || !f(t) || !1, c = 0, u = (h = t.toString().split("").reverse()).length; c < u; c++) "." === (o = h[c]) && (a = !0), this.addDigit(o, a);
        return this.startWatchingMutations()
    }, v.prototype.update = function(t) {
        var e, i = this;
        return (e = (t = this.cleanValue(t)) - this.value) ? (s(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), k(this.el, 0 < e ? "odometer-animating-up" : "odometer-animating-down"), this.stopWatchingMutations(), this.animate(t), this.startWatchingMutations(), setTimeout(function() {
        ...
        var o = n('<span class="odometer-formatting-mark"></span>');
        return o.innerHTML = t, i && k(o, i), this.insertDigit(o, e)
        ...
        if (o = +e - this.value) return s = n = l(), i = this.value, (r = function() {
            var t;
            return l() - s > a.options.duration ? (a.value = e, a.render(), void m(a.el, "odometerdone")) : (50 < (t = l() - n) && (n = l(), t = t / a.options.duration, i += o * t, a.render(Math.round(i))), null != h ? h(r) : setTimeout(r, 50))
        })()
    }, v.prototype.getDigitCount = function() {
        for (var t, e, i, o = 1 <= arguments.length ? y.call(arguments, 0) : [], n = i = 0, s = o.length; i < s; n = ++i) e = o[n], o[n] = Math.abs(e);
        return t = Math.max.apply(Math, o), Math.ceil(Math.log(t + 1) / Math.log(10))
    }, v.prototype.getFractionalDigitCount = function() {
        for (var t, e, i = 1 <= arguments.length ? y.call(arguments, 0) : [], o = /^\-?\d*\.(\d*?)0*$/, n = e = 0, s = i.length; e < s; n = ++e) t = i[n], i[n] = t.toString(), t = o.exec(i[n]), i[n] = null == t ? 0 : t[1].length;
        return Math.max.apply(Math, i)
    }, v.prototype.resetDigits = function() {
        return this.digits = [], this.ribbons = [], this.inside.innerHTML = "", this.resetFormat()
    }, v.prototype.animateSlide = function(t) {
        var e, i, o, n, s, r, a, l, c, d, u, h, p, f, m, g, y, v, w, b, x, _, $, C, T, S = this.value,
            E = this.getFractionalDigitCount(S, t);
        if (E && (t *= Math.pow(10, E), S *= Math.pow(10, E)), o = t - S) {
            for (this.bindTransitionEnd(), n = this.getDigitCount(S, t), s = [], d = y = e = 0; 0 <= n ? y < n : n < y; d = 0 <= n ? ++y : --y) {
                if (m = A(S / Math.pow(10, n - d - 1)), r = (a = A(t / Math.pow(10, n - d - 1))) - m, Math.abs(r) > this.MAX_VALUES) {
                    for (c = [], u = r / (this.MAX_VALUES + this.MAX_VALUES * e * .5), i = m; 0 < r && i < a || r < 0 && a < i;) c.push(Math.round(i)), i += u;
                    c[c.length - 1] !== a && c.push(a), e++
                } else c = function() {
                    T = [];
                    for (var t = m; m <= a ? t <= a : a <= t; m <= a ? t++ : t--) T.push(t);
                    return T
                }.apply(this);
                for (d = v = 0, b = c.length; v < b; d = ++v) l = c[d], c[d] = Math.abs(l % 10);
                s.push(c)
            }
            for (this.resetDigits(), d = w = 0, x = (C = s.reverse()).length; w < x; d = ++w)
                for (c = C[d], this.digits[d] || this.addDigit(" ", E <= d), null == (g = this.ribbons)[d] && (g[d] = this.digits[d].querySelector(".odometer-ribbon-inner")), this.ribbons[d].innerHTML = "", o < 0 && (c = c.reverse()), h = $ = 0, _ = c.length; $ < _; h = ++$) l = c[h], (f = document.createElement("div")).className = "odometer-value", f.innerHTML = l, this.ribbons[d].appendChild(f), h === c.length - 1 && k(f, "odometer-last-value"), 0 === h && k(f, "odometer-first-value");
    ...
    }, (r = v).options = null != (g = window.odometerOptions) ? g : {}, setTimeout(function() {
        var t, e, i, o, n;
        if (window.odometerOptions) {
            for (t in n = [], o = window.odometerOptions) e = o[t], n.push(null != (i = r.options)[t] ? (i = r.options)[t] : i[t] = e);
            return n
        }
    }, 0), r.init = function() {
        var t, e, i, o, n, s;
        if (null != document.querySelectorAll) {
            for (s = [], i = 0, o = (e = document.querySelectorAll(r.options.selector || ".odometer")).length; i < o; i++) t = e[i], s.push(t.odometer = new r({
                el: t,
        ...
        return "complete" === document.readyState && !1 !== r.options.auto && r.init(), null != e ? e.apply(this, arguments) : void 0
    ...
    function(t) {
            ...
            open: function(t) {
                ...
                if (!f.isOpen) {
                    f.types = [], g = "", t.mainEl && t.mainEl.length ? f.ev = t.mainEl.eq(0) : f.ev = m, t.key ? (f.popupsCache[t.key] || (f.popupsCache[t.key] = {}), f.currTemplate = f.popupsCache[t.key]) : f.currTemplate = {}, f.st = c.extend(!0, {}, c.magnificPopup.defaults, t), f.fixedContentPos = "auto" === f.st.fixedContentPos ? !f.probablyMobile : f.st.fixedContentPos, f.st.modal && (f.st.closeOnContentClick = !1, f.st.closeOnBgClick = !1, f.st.showCloseBtn = !1, f.st.enableEscapeKey = !1), f.bgOverlay || (f.bgOverlay = u("bg").on("click" + b, function() {
                        f.close()
                    }), f.wrap = u("wrap").attr("tabindex", -1).on("click" + b, function(t) {
                    ...
                    }, 16), f.isOpen = !0, f.updateSize(r), h(w), t
                }
                f.updateItemHTML()
            },
            close: function() {
        ...
        c.magnificPopup.registerModule(M, {
            ...
            proto: {
                initAjax: function() {
                    f.types.push(M), z = f.st.ajax.cursor, d(l + "." + M, A), d("BeforeChange." + M, A)
                },
                getAjax: function(o) {
                    z && c(document.body).addClass(z), f.updateStatus("loading");
                    var t = c.extend({
                        url: o.src,
                        success: function(t, e, i) {
                            ...
                            h("ParseAjax", i), f.appendContent(c(i.data), M), o.finished = !0, k(), f._setFocus(), setTimeout(function() {
                                f.wrap.addClass(x)
                            }, 16), f.updateStatus("ready"), h("AjaxContentAdded")
                        },
                        error: function() {
                            k(), o.finished = o.loadError = !0, f.updateStatus("error", f.st.ajax.tError.replace("%url%", o.src))
                        }
                    }, f.st.ajax.settings);
        ...
        c.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    var s = f.st.gallery,
                        t = ".mfp-gallery";
                    return f.direction = !0, !(!s || !s.enabled) && (g += " mfp-gallery", d(w + t, function() {
                ...
                _preloadItem: function(t) {
                    var e;
                    t = j(t), f.items[t].preloaded || ((e = f.items[t]).parsed || (e = f.parseEl(t)), h("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        c.magnificPopup.registerModule(H, {
            ...
            proto: {
                initRetina: function() {
                    var i, o;
                    1 < window.devicePixelRatio && (i = f.st.retina, o = i.ratio, 1 < (o = isNaN(o) ? o() : o) && (d("ImageHasSize." + H, function(t, e) {
                        e.img.css({
    ...
    function() {
        ...
        function y() {
            ...
            }, setTimeout(a, 10), L("resize", a), (r = new B(a)).observe(t, {
                attributes: !0,
                childList: !0,
                characterData: !1
            }), h.offsetHeight <= s && ((s = document.createElement("div")).style.clear = "both", t.appendChild(s))), f.fixedBackground || l || (t.style.backgroundAttachment = "scroll", e.style.backgroundAttachment = "scroll"))
        }
        var v = [],
            w = !1,
            b = Date.now();
        ...
        function x(c, d, u) {
            var t, e, i, h, p;
            t = 0 < (t = d) ? 1 : -1, e = 0 < (e = u) ? 1 : -1, o.x === t && o.y === e || (o.x = t, o.y = e, v = [], b = 0), 1 != f.accelerationMax && ((e = Date.now() - b) < f.accelerationDelta && (1 < (i = (1 + 50 / e) / 2) && (i = Math.min(i, f.accelerationMax), d *= i, u *= i)), b = Date.now()), v.push({
                x: d,
                y: u,
                lastX: d < 0 ? .99 : -.99,
                lastY: u < 0 ? .99 : -.99,
                start: Date.now()
            }), w || (i = F(), h = c === i || c === document.body, null == c.$scrollBehavior && function(t) {
                var e = T(t);
                null == k[e] && (t = getComputedStyle(t, "")["scroll-behavior"], k[e] = "smooth" == t);
                return k[e]
                ...
                for (var e = Date.now(), i = 0, o = 0, n = 0; n < v.length; n++) {
                    var s = v[n],
                        r = e - s.start,
                        a = r >= f.animationTime,
                        l = a ? 1 : r / f.animationTime;
                    f.pulseAlgorithm && (l = function(t) {
                        if (1 <= t) return 1;
                        if (t <= 0) return 0;
                        1 == f.pulseNormalize && (f.pulseNormalize /= R(1));
                        return R(t)
                    }(l));
                    r = s.x * l - s.lastX >> 0, l = s.y * l - s.lastY >> 0;
                    i += r, o += l, s.lastX += r, s.lastY += l, a && (v.splice(n, 1), n--)
                }
                h ? window.scrollBy(i, o) : (i && (c.scrollLeft += i), o && (c.scrollTop += o)), d || u || (v = []), v.length ? W(p, c, 1e3 / f.frameRate + 1) : (w = !1, null != c.$scrollBehavior && (c.style.scrollBehavior = c.$scrollBehavior, c.$scrollBehavior = null))
            }, W(p, c, 0), w = !0)
        }
        ...
        function t(t) {
            ...
            p && (t.wheelDeltaX && H(t.wheelDeltaX, 120) && (i = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120), t.wheelDeltaY && H(t.wheelDeltaY, 120) && (o = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)), i || o || (o = -t.wheelDelta || 0), 1 === t.deltaMode && (i *= 40, o *= 40);
            e = M(e);
            return e ? !! function(t) {
                if (!t) return;
                s.length || (s = [t, t, t]);
                ...
                var e = 120 < t && q(t),
                    e = !q(120) && !q(100) && !e;
                return t < 50 || e
            }(o) || (1.2 < Math.abs(i) && (i *= f.stepSize / 120), 1.2 < Math.abs(o) && (o *= f.stepSize / 120), x(e, i, o), t.preventDefault(), void A()) : !d || !X || (Object.defineProperty(t, "target", {
        ...
        function _(t) {
            var e = t.target,
                i = t.ctrlKey || t.altKey || t.metaKey || t.shiftKey && t.keyCode !== m.spacebar;
            ...
            var n = 0,
                s = 0,
                r = M(c);
            if (!r) return !d || !X || parent.keydown(t);
            ...
            x(r, n, s), t.preventDefault(), A()
        }

        function e(t) {
            c = t.target
        }
        var $, C, T = ($ = 0, function(t) {
                return t.uniqueID || (t.uniqueID = $++)
            }),
            S = {},
            E = {},
            k = {};
        ...
        function z(t, e, i) {
            for (var o = i ? S : E, n = t.length; n--;) o[T(t[n])] = e;
            return e
        }
        ...
        function M(t) {
            ...
            do {
                ...
                if (e.push(t), o === t.scrollHeight) {
                    n = I(h) && I(i) || P(h);
                    if (d && O(h) || !d && n) return z(e, F())
                } else if (O(t) && P(t)) return z(e, t)
        ...
        function q(t) {
            return H(s[0], t) && H(s[1], t) && H(s[2], t)
        }
        var V, W = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(t, e, i) {
                window.setTimeout(t, i || 1e3 / 60)
            },
            B = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver,
            F = (V = document.scrollingElement, function() {
                var t, e;
        ...
        function R(t) {
            var e;
            return ((t *= f.pulseScale) < 1 ? t - (1 - Math.exp(-t)) : (--t, (e = Math.exp(-1)) + (1 - Math.exp(-t)) * (1 - e))) * f.pulseNormalize
        }
        var N = window.navigator.userAgent,
            ...
            Z = G && (/Version\/8/i.test(N) || /Version\/9/i.test(N)),
            Y = (X || G || Y) && !Q,
            U = !1;
        try {
        ...
        function J(t) {
            for (var e in t) i.hasOwnProperty(e) && (f[e] = t[e])
        }
